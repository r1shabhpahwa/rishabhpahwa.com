...
const projects = [
  {
    ...
    description:
      "<p>A locally-hosted <strong>RAG chatbot</strong> that answers technical questions about my professional experience and homelab infrastructure. Built with <strong>Llama 3.1 (8B)</strong> via <strong>Ollama</strong>, running entirely on my own hardware without commercial APIs.</p><p>The backend uses <strong>Node.js</strong> and <strong>LangChain.js</strong> to handle document chunking, vector embeddings (<strong>ChromaDB</strong>), and context-augmented queries to the local LLM. The <strong>React/Next.js</strong> frontend provides a responsive chat interface.</p><p>Demonstrates practical experience deploying modern LLM applications on self-hosted infrastructure, from data processing to production deployment.</p>",
